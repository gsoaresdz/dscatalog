...
public class ProductResourceTests {
	...
	public void insertShouldReturnProductDTOCreated() throws Exception {
		...
		ResultActions result = mockMvc
				.perform(post("/products/", existingId).header("Authorization", "Bearer " + accessToken).content(jsonBody)
	...
	public void updateShouldReturnProductDTOWhenIdExists() throws Exception {
		...
		ResultActions result = mockMvc
				.perform(put("/products/{id}", existingId).header("Authorization", "Bearer " + accessToken).content(jsonBody)
						.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
	...
	public void updateShouldReturnNotFoundWhenIdDoesNotExist() throws Exception {
		...
		ResultActions result = mockMvc
				.perform(put("/products/{id}", nonExistingId).header("Authorization", "Bearer " + accessToken).content(jsonBody)
						.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
